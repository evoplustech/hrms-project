...
const PicklistForm = ({selectedOption,setPopup,value={}}) => {
  ...
  <form className="mt-10">
    <div className='ps-20 pe-10'>
      <div className={`grid ${picklistType.toLowerCase()==='reason' ? 'grid-cols-1' : 'grid-cols-2'} gap-1`}>
        ...
        <div className="items-start">
          <label for="Name" className="block mb-2 text-base font-semibold text-gray-900 dark:text-white">Name</label>
        ...
        </div>
        {
          ...
          <div className=" ">
            <label for="Description" className="block mb-2 text-base font-semibold text-gray-900 dark:text-white">Description</label>
    ...
    <div className="flex justify-center mt-10 mb-8">
        <button onClick = {submitHandler} className="text-white hover:bg-green-600 px-6 py-1.5 bg-emerald-500 w-1/5 rounded capitalize">{action}</button>
      </div>
  </form>
  </>
  )
