                    ...
                    <div className="w-full">
                        <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div className="flex flex-col pb-3">
                                ...
                                <dd className="text-lg font-semibold">{contactInfo['address'].street}</dd>
                            </div>

                            <div className="flex flex-col pt-3">
                                <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Phone Number</dt>
                                <dd className="text-lg font-semibold">{contactInfo.phone}</dd>
                            </div>
                            <div className="flex flex-col pt-3">
                                <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Email</dt>
                                <dd className="text-lg font-semibold">{contactInfo.email}</dd>
                            </div>

                            <div className="flex flex-col pt-3">
                                <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">maritalStatus</dt>
                                <dd className="text-lg font-semibold">{maritalStatus}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
                    ...
                    <div className="w-full">
                        <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div className="flex flex-col pb-3">
                                ...
                                <dd className="text-lg font-semibold">{designation.name}</dd>
                            </div>
                            <div className="flex flex-col py-3">
                            ...
                            <div className="flex flex-col py-3">
                                ...
                                <dd className="text-lg font-semibold">{`${managerId.firstName} ${managerId.lastName}`}</dd>
                            </div>
                        </dl>
                    </div>
