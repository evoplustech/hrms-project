...
const EmployeeProfile = () => {
    ...
    return (<>
        ...
        <p className="w-fit text-gray-700 dark:text-gray-400 text-xl font-bold  ms-0">Personal Details</p>
        ...
        <div className="w-full my-auto py-6 flex flex-col justify-center gap-2">
                ...
                <div className="w-full">
                    <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3">
                            ...
                            <dd className="text-lg font-semibold min-h-7">{firstName}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Last Name</dt>
                            <dd className="text-lg font-semibold min-h-7">{lastName}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                        ...
                        <div className="flex flex-col py-3">
                            ...
                            <dd className="text-lg font-semibold min-h-7">{gender}</dd>
                        </div>
                    </dl>
                </div>
                <div className="w-full">
                    <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3">
                            ...
                            <dd className="text-lg font-semibold min-h-7">{contactInfo['address']?.street}</dd>
                        </div>

                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Phone Number</dt>
                            <dd className="text-lg font-semibold min-h-7">{contactInfo.phone}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Email</dt>
                            <dd className="text-lg font-semibold min-h-7">{contactInfo.email}</dd>
                        </div>

                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">maritalStatus</dt>
                            <dd className="text-lg font-semibold min-h-7">{maritalStatus}</dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div className="flex justify-center items-center  my-10">
                <p className="flex justify-center items-center  text-gray-700 dark:text-gray-400 text-xl font-bold mb-4">Professional Details</p>
            </div>
            ...
            <div className="w-full flex sm:flex-row xs:flex-col gap-2 justify-center">
                <div className="w-full">
                    <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Designation</dt>
                            <dd className="text-lg font-semibold min-h-7">{designation.name}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Department</dt>
                            <dd className="text-lg font-semibold min-h-7">{department.name}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Role</dt>
                            <dd className="text-lg font-semibold min-h-7">{role.name}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Reporting Manager</dt>
                            <dd className="text-lg font-semibold min-h-7">{`${managerId?.firstName} ${managerId?.lastName}`}</dd>
                        </div>
                    </dl>
                </div>
                ...
                <div className="w-full ">
                    <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Employee ID</dt>
                            <dd className="text-lg font-semibold min-h-7">{employeeId}</dd>
                        </div>

                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Shift Name</dt>
                            <dd className="text-lg font-semibold min-h-7">{shift.name}</dd>
                        </div>
                        <div className="flex flex-col py-3">
                        ...
                        <div className="flex flex-col py-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Employment Type</dt>
                            <dd className="text-lg font-semibold hover:text-blue-500">{employmentType}</dd>
                        </div>
                    </dl>
                </div>
            </div>
