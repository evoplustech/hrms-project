  ...
  return (
    <>
      ...
      <div id="accordion-collapse" data-accordion="collapse">
        ...
        >
          <Link to={'/home/configuration/picklist'} className={`flex justify-start mt-2 px-2 py-1 border  hover:bg-orange-100 hover:text-orange-600 rounded-e-full font-semibold cursor-pointer`}>
          ...
          <Link to={'/home/configuration/cronsetup'} className={`flex justify-start mt-2 px-2 py-1 border  hover:bg-orange-100 hover:text-orange-600 rounded-e-full font-semibold cursor-pointer`}>
